...
if(list.isEmpty()==true)
{
	...
	String message="Customer not found!!! ";
	response.sendRedirect("custdetails_admin.jsp?message="+message);
}
...
<tr><td>&nbsp;</td></tr>
		...
		<tr>
                      <td valign="top" size="30%" ><strong> See the offer ! Enter the Location </strong></td>
                       <td valign="top" size="30%"><input type="text" name="offloc" /></td>
                     </tr>
                     <tr><td valign="top" colspan=2 align="center"><label>
                         
                         <td valign="top"><input type="submit" name="Submit4" onclick="submitForm('offerdetails1_admin.jsp')" value="Get Offer"></td>
                   ...
                   <tr>
					...
					<tr>
                       <td valign="top" colspan=2 align="center"><label>
                         ...
                         <td valign="top"><input type="submit" name="Submit4" onclick="submitForm('email_admin.jsp')" value="Send"></td>
                       </label></td>
                   </tr>
                    <%
                    String email="";
