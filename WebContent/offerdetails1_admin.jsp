...
<%
String offerLocation =request.getParameter("offloc");

/* String offerID =offerLocation.toUpperCase();

ReadFileData bcd= new ReadFileData();
Map<String,String> offer ;

  offer = bcd.getOffer(offerID); */
  
  ArrayList<Offer> list=BlueCommerceDao.getOfferData(offerLocation);
  ...
  if(list.isEmpty()==true)
  {
	...
	response.sendRedirect("offerdetails_admin.jsp?message="+message);
...
<br/>
 ...
 <table border="1" dir="ltr" height="131" width="1000">
	...
	<tbody>
		<tr>
			<td style="width: 114px; text-align: center;"><strong>Offer ID</strong></td>
			<td style="width: 149px; text-align: center;"><strong>Location </strong></td>
			<td style="width: 149px; text-align: center;"><strong>Class A Hotel Name</strong></td>
			<td style="width: 326px; text-align: center;"><strong>Class B Hotel Name</strong></td>
			<td style="width: 190px; text-align: center;"><strong>Class C Hotel Name</strong></td>
			<td style="width: 126px; text-align: center;"><strong>Travel Agent A</strong></td>
			<td style="width: 126px; text-align: center;"><strong>Travel Agent B</strong></td>
			<td style="width: 126px; text-align: center;"><strong>Helpline No</strong></td>
			<td style="width: 126px; text-align: center;"><strong>Discount</strong></td>

		</tr>
		
		<c:forEach var="offer" items="${offerdetails}"> 
		<tr>
			<td style="width: 114px; text-align: center;">${offer.offerid}</td>
			<td style="width: 149px; text-align: center;">${offer.location}</td>
			<td style="width: 149px; text-align: center;">${offer.hotelclassa}</td>
			<td style="width: 326px; text-align: justify;">${offer.hotelclassb}</td>
			<td style="width: 190px; text-align: center;">${offer.hotelclassc}</td>
			<td style="width: 126px; text-align: center;">${offer.travelclassa}</td>
			<td style="width: 126px; text-align: center;">${offer.travelclassb}</td>
			<td style="width: 126px; text-align: center;">${offer.helpline}</td>
			<td style="width: 126px; text-align: center;">${offer.discount}</td>
