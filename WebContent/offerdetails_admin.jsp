...
<table border=0 cellpadding="3" width="100%">      
        <tr>
           <td valign="top" class="template">
               <form name="FrmIndex" method="post" action="offerdetails1_admin.jsp" >
                ...
                <tr><td>&nbsp;</td>
                   ...
                   <!-- <tr>
                      ...
                      <tr>
                      	<td>&nbsp;</td><tr>
                      <td valign="top" colspan=2 align="center" size="30%" ><strong> Please Enter the Location Name : </strong></td></tr>
