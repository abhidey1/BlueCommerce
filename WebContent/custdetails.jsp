...
<ul id="drop-nav">
  ...
  <ul>
      <li><a href="#" ><font face="verdana" size="1">View Customer </font></a></li>
...
<table border="0" cellspacing="3" cellpadding="4" bgcolor="#FFFFFF" width="800"> 
        <tr>
           <td valign="top" class="template">
               <form name="FrmIndex" method="post" action="custdetails1.jsp">
                ...
                <tr><td>&nbsp;</td>
                   ...
                   <tr>
                      <td colspan=2 valign="top" class="heading"><strong>Your valuable Customers !! </strong></td>
                   </tr>
                    
                       <td valign="top" class="template"><strong>Your Customer ID </strong></td>
                       <td valign="top"><input type="text" name="custId" /></td>
                     </tr>
                     
                     <tr>
                       <td valign="top" colspan=2 align="center"><label>
                         <input type="submit" name="Submit7" value="Search"/>
