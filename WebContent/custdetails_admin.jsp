...
function validate()
{
	if(document.FrmIndex.custId.value=="")
	{
...
<%}%>
               ...
               <form name="FrmIndex" method="post" action="custdetails1_admin.jsp">
                ...
                <tr><td>&nbsp;</td>
                   ...
                   <tr>
                      <td colspan=2 valign="top" class="heading">&nbsp;</td>
                       ...
                       <td valign="top" class="template"><strong>Enter Customer ID </strong></td>
                       <td valign="top"><input type="text" name="custId" /></td>
                     </tr>
                     
                     <tr>
                       <td valign="top" colspan=2 align="center"><label>
                         <input type="submit" name="Submit7" value="Search" onclick="return validate()"/>
